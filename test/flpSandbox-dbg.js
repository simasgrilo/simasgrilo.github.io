		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CV in UI5",
									"targetURL": "#comsimasgrilohomepagehomepageui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsimasgrilohomepagehomepageui5-display": {
								"semanticObject": "comsimasgrilohomepagehomepageui5",
								"action": "display",
								"description": "A simple homepage carrying CV information built using SAPUI5",
								"title": "CV in UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.simasgrilo.homepage.homepageui5",
									"url": sap.ui.require.toUrl("com/simasgrilo/homepage/homepageui5")
								}
							}
						}
					}
